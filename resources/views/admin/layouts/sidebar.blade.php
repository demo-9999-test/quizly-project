...
<div id="sidebar_menu" class="sidebar-menu scrollable">
    <div class="input-group search-input">
        <input type="text" class="form-control" id="searchInput11" placeholder="{{ __('Search here...') }}"
            autocomplete="off">
    ...
    <ul id="resultList11" class="transparent-background search_result_list search_result_list_one"></ul>
