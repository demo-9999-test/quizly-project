...
<div class="dashboard-card">
    ...
    <div class="col-md-6 col-lg-6">
        <div class="widget-button">
            <a href="{{ route('zone.index') }}" class="btn btn-primary" title="{{ __('Back') }}"><i
                                    ...
                                    <td>
                                        <div class="dropdown action-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ url('admin/zone/' . $data->id . '/restore') }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form method="post"
                                                    action="{{ url('admin/zone/' . $data->id . '/trash-delete') }}"
                                                    class="pull-right">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="bulk_delete_form" method="post" action="{{route('zone.trash_bulk_delete')}}">
                        @csrf
                        @method('POST')
