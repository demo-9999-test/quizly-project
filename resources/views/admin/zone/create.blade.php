                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="zoneName" placeholder="{{ __('Enter Name of your Zone') }}" aria-label="Zone Name" value="{{ old('name') }}">
