        ...
        @slot('button')
            ...
            <div class="col-md-6 col-lg-6">
                <div class="widget-button">
                    @can('zone.create')
                        <a href="{{route('zone.create')}}" type="button" title="{{__('Add Zone')}}" class="btn btn-primary p-2">
                        <i class="flaticon-plus"></i>  {{ __('Add Zone') }}</a>
                    @endcan
                    @can('zone.delete')
                        ...
                        <a href="{{route('zone.trash')}}" type="button" class="btn btn-success"
                        ...
                        <table  class="table data-table table-borderless"  id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (!empty($data->image))
                                            <img src="{{ asset('/images/zone/' . $data->image) }}" alt=" {{ __('user img') }}" class="widget-img img-fluid">
                                            @else
                                    ...
                                    <td>
                                        <div class="dropdown action-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    @can('zone.edit')
                                                        <a href="{{route('zone.edit', ['id' => $data->id])}}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="deleteForm" action="{{route('zone.destroy', ['id' => $data->id])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="bulk_delete_form" method="post" action="{{route('zone.bulk_delete')}}">
                    @csrf
                    @method('POST')
