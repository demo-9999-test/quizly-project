                        ...
                        <div class="row">
                            ...
                            @csrf
                                <div class="form-group">
                                    <label for="">{{ __('Select Users Group') }}: <span
                                            ...
                                            <select required data-placeholder="Please select user group" name="user_group" id="user_group" class="select2 form-control">
                                                ...
                                                <option {{ old('user_group') == 'all_admins' ? "selected" : "" }} value="all_admins">
                                                    {{ __('All Admins') }} </option>
                                                <option {{ old('user_group') == 'all' ? "selected" : "" }} value="all">
                                                    {{ __('All (Users + Admins)') }}</option>
                                            </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="text-info">
                                        <i class="fa fa-question-circle"></i> {{ __('On click of notification where you want toredirect the user') }}.
                                    </small>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary-rgba" title="{{ __('Send') }}"><i class="fa fa-check-circle"></i>{{ __('Send') }}</button>
                                </div>
                            </div>
                        </form>
