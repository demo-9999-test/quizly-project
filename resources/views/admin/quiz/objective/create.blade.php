            ...
            <div class="row">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-mcq" role="tabpanel"
                        ...
                        <!-- MCQ Form code start -->
                        <form id="multipleChoiceForm" action="{{ route('objective.create_post',['id' => $quiz->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="question" id="question" placeholder="{{ __('Please enter your question ') }}" aria-label="question">
                                    ...
                                    <div class="col-lg-2 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" name="mark" id="mark" placeholder="{{ __('Enter mark') }}" aria-label="mark">
                                    ...
                                    <div class="col-lg-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="option_a" id="option_a" placeholder="{{ __('Please enter Option A') }}" aria-label="option_a">
                                    ...
                                    <div class="col-lg-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="option_b" id="option_b" placeholder="{{ __('Please enter Option B') }}" aria-label="option_b">
                                            <div class="form-control-icon"><i class="flaticon-b"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="option_c" id="option_c" placeholder="{{ __('Please enter Option C') }}" aria-label="option_c">
                                    ...
                                    <div class="col-lg-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="option_d" id="option_d" placeholder="{{ __('Please enter Option D') }}" aria-label="option_d">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="correct_answer" id="correct_answer" aria-label="correct_answer">
                                                ...
                                                <option value="Option A">{{__('Option A')}}</option>
                                                <option value="Option B">{{__('Option B')}}</option>
                                                <option value="Option C">{{__('Option C')}}</option>
                                                <option value="Option D">{{__('Option D')}}</option>
                                            </select>
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="url" name="audio" id="link" placeholder="{{ __('Your audio link here') }}" aria-label="link">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="url" name="video" id="video" placeholder="{{ __('Your video  link here') }}" aria-label="link">
                    ...
                    <div class="tab-pane fade" id="v-pills-true_false" role="tabpanel"
                        ...
                        <form id="trueFalseForm" action="{{ route('objective.create_post',['id' => $quiz->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="question" id="questiontrue" placeholder="{{ __('Please enter your question ') }}" aria-label="question">
                                            <div class="form-control-icon"><i class="flaticon-question-2"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            <label for="mark" class="form-label">{{ __('Question Mark') }}<span class="required">*</span></label>
                                            <input class="form-control" type="number" name="mark" id="mark" placeholder="{{ __('Please enter mark') }}" aria-label="mark">
                                            <div class="form-control-icon"><i class="flaticon-alert"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-icon"><i class="flaticon-close"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                    ...
                    <div class="tab-pane fade" id="v-pills-fill_blanks" role="tabpanel"
                        ...
                        <form id="fill_blank" action="{{ route('objective.create_post',['id' => $quiz->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control fill_question " type="text" name="question" id="questionfillup" placeholder="{{ __('Please enter your question ') }}" aria-label="question">
                                            <div class="form-control-icon"><i class="flaticon-question-2"></i></div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                            <label for="correct_answer" class="form-label">{{ __('Correct Answer') }}<span class="required">*</span></label>
                                            <input class="form-control" type="text" name="correct_answer" id="correct_answer" placeholder="{{ __('Please enter your question ') }}" aria-label="correct_answer"><div class="form-control-icon"><i class="flaticon-check-mark"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="text" name="question" id="questionmatch" placeholder="{{ __('Please enter your question ') }}" aria-label="question">
                                            <div class="form-control-icon"><i class="flaticon-question-2"></i></div>
                                        </div>
                                        <div class="row" id="options-container">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label">{{__('A')}}<span class="required">*</span></label>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label">{{__('1')}}<span class="required">*</span></label>
                                            ...
                                            <div class="row" id="correct-options-container">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="correct_answer_left[]" value="A" disabled>
                                                        <div class="form-control-icon"><i class="flaticon-process"></i></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="audio" class="form-label">{{ __('Video Link') }}</label>
                                                    <input class="form-control" type="url" name="audio" id="link" placeholder="{{ __('Your video link here') }}" aria-label="link">
                                                    <div class="form-control-icon"><i class="flaticon-video"></i></div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
