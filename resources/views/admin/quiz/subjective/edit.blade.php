...
@section('main-container')
    <div class="dashboard-card">
        ...
        <div class="contentbar">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="multipleChoiceForm" action="{{ route('subjective.edit_post', ['id' => $quiz->id, 'sub_id' => $sub->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-9 col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="question" id="question" placeholder="{{ __('Please enter your question  ') }}" aria-label="question" value="{{ isset($sub->question) ? $sub->question : '' }}">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="mark" id="mark" placeholder="{{ __('Please enter mark') }}" aria-label="mark" value="{{ isset($sub->mark) ? $sub->mark : '' }}">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="url" name="audio" id="audio" placeholder="{{ __('Please paste your audio link here') }}" aria-label="link" value="{{ isset($sub->audio) ? $sub->audio : '' }}">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="url" name="video" id="video" placeholder="{{ __('Please paste your video link here') }}" aria-label="link" value="{{ isset($sub->video) ? $sub->video : '' }}">
