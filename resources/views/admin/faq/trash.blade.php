                        ...
                        <table class="table data-table text-center" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ \Illuminate\Support\Str::limit(strip_tags($data->question), $limit = 20, $end = '...') }}
                                    </td>

                                    <td>
                                        {{ \Illuminate\Support\Str::limit(strip_tags($data->answer), $limit = 50, $end = '...') }}
                                    </td>
                                    <td>
                                        @if ($data->status == 1)
                                    ...
                                    <td>
                                        <div class="dropdown action-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ url('admin/faq/' . $data->id . '/restore') }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form method="post"
                                                    action="{{ url('admin/faq/' . $data->id . '/trash-delete') }}"
                                                    class="pull-right">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
...
<div class="modal fade" id="bulk_delete" tabindex="-1" aria-labelledby="bulkDeleteLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" title="{{ __('No') }}" class="btn btn-secondary" data-bs-dismiss="modal">{{
                    __('No') }}</button>
                <form id="bulk_delete_form" method="post" action="{{ route('faq.trash_bulk_delete') }}">
                    @csrf
                    @method('POST')
