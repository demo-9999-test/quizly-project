        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        @foreach ($userAnswer as $data)
                            @if($data->answer_approved === 1)
                                <div class="question-answer-block passed mb_20">
                                    <div class="row">
                                        <div class="col-lg-11">
                                            <h4 class="question-answer-title">  <span>{{('Q: ')}}</span> {{$data->question->question }}</h4>
                                            <p class="question-answer-txt"> <span>{{('Ans: ')}}</span> {{$data->answer }}</p>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <a href="{{ route('download.pdf', ['quiz_id' => $quiz->id, 'user_id' => $user->id]) }}" class="btn btn-primary" id="downloadBtn">{{__('Download report')}}</a>
                    </div>
                    <div class="col-lg-3">
