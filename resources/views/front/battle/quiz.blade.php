        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="question-block">
                    ...
                    <form action="{{route('battle.submit',['id' => $quiz->id, 'question_id' => 0,'battle_id' => $battle->id])}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 text-center">
                                                                <label class="btn options">
                                                                    <input type="radio" name="user_answer[{{ $question['id'] }}]" value="Option A" class="d-none">
                                                                    {{ 'A. '.$question['option_a'] }}
                                                                </label>
                                                            </div>
                                                            <div class="col-lg-6 text-center">
                                                                <label class="btn options">
                                                                    <input type="radio" name="user_answer[{{ $question['id'] }}]" value="Option B" class="d-none">
                                                                    {{ 'B. '.$question['option_b'] }}
                                                                </label>
                                                            </div>
                                                            <div class="col-lg-6 text-center">
                                                                <label class="btn options">
                                                                    <input type="radio" name="user_answer[{{ $question['id'] }}]" value="Option C" class="d-none">
                                                                    {{ 'C. '.$question['option_c'] }}
                                                                </label>
                                                            </div>
                                                            <div class="col-lg-6 text-center">
                                                                <label class="btn options">
                                                                    <input type="radio" name="user_answer[{{ $question['id'] }}]" value="Option D" class="d-none">
                                                                    {{ 'D. '.$question['option_d'] }}
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        @elseif($question['ques_type'] === 'true_false')
                                                            <div class="row">
                                                                <div class="col-lg-6 text-center">
                                                                    <label class="btn options">
                                                                        <input type="radio" name="user_answer[{{ $question['id'] }}]" value="True" class="d-none">
                                                                        {{ 'A. '.$question['option_a'] }}
                                                                    </label>
                                                                </div>
                                                                <div class="col-lg-6 text-center">
                                                                    <label class="btn options">
                                                                        <input type="radio" name="user_answer[{{ $question['id'] }}]" value="False" class="d-none">
                                                                        {{ 'B. '.$question['option_b'] }}
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row mt-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label class="btn options">
                                                                        <input type="radio" name="user_answer[{{ $question['id'] }}]" value="{{ implode('||', $sequence) }}" class="d-none">
                                                                        <ul>
                                                                            @php
                                                                            $char = 'A';
                                                                            @endphp
