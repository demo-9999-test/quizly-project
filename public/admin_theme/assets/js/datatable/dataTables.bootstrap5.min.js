...
!(function (t) {
    ...
    return (
        x.extend(!0, i.defaults, {
            dom: "<'row mb-4'<'col-sm-12 col-md-3 col-lg-4'l><'col-sm-12 col-md-6 col-lg-4 datatable-button'><'col-sm-12 col-md-3 col-lg-4'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
            renderer: "bootstrap",
        }),
