      ...
      function r(e) {
        ...
        for (var t = a.selection.blocks(), n = 0; n < t.length; n++)
          if (
            ...
            ("LI" !== t[n].tagName || "LI" !== t[n].parentNode.tagName)
          ) {
            var r = s(t[n]);
            "LI" != t[n].tagName &&
              "LI" == t[n].parentNode.tagName &&
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  !a.previousSibling &&
                  ((a.nextSibling && "TABLE" == a.nextSibling.tagName) ||
                    (a.nextSibling &&
                      a.nextSibling.nextSibling &&
                      "TABLE" == a.nextSibling.nextSibling.tagName))
                ) {
                  r.appendChild(a), (a = l);
                  continue;
                }
    ...
    (V.MODULES.keys = function (d) {
      ...
      function h(e) {
        if (d.selection.isCollapsed())
          if (
            (["INPUT", "BUTTON", "TEXTAREA", "DIV", "BODY"].indexOf(
              ...
              d.el.addEventListener("compositionstart", function () {
                if (d.selection.isCollapsed()) {
                  ...
                  if (
                    ...
                    i(r.get(0).previousSibling).before(V.HAIR_SPACE),
